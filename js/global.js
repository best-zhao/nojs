define("global", [ "./lib/jquery", "./lib/ui" ], function(require) {
    var $ = require("./lib/jquery"), ui = require("./lib/ui");
...
!function(window, factory) {
    ...
    ui.touch = function(callback) {
        require.async("lib/touch", callback);
    };
    if (screen.width <= 640) {
        ui.mobile = true;
        ui.touch();
    ...
    ui.overlay.prototype.on = function(options) {
        options = options || {};
        var self = this, mode = options.mode || ui.config.eventType, agent = $.type(options.element) == "array" && options.element.length > 1, hasNearby = !!this.nearby, element = getDom(agent ? options.element[0] : options.element) || this.nearby, hoverClass = this.options.hoverClass || "nj_overlay_show", isHover, show, hide, showTime, hideTime, hideEvent;
        if (!element) {
            return;
        }
