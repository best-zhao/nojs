...
define(function(require){
	...
	player.prototype = {
		...
		load : function(index, resize){
			...
			this.wrap.find('a[data-action="src"]').attr({'href':src,'target':'_blank'});
			...
			this.info.find('.pic_list .list').children().eq(index).addClass('current').siblings().removeClass('current');
		},
