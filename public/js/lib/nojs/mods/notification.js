 ...
 * 2014-4-10
 */
define("lib/nojs/mods/notification", [], function(require) {
    function DesktopNotification(options) {
        ...
        */
        ...
        this.notification = null, this.permissionStatue = 1, //PERMISSION_ALLOWED: 0,  PERMISSION_NOT_ALLOWED: 1, PERMISSION_DENIED: 2
        this.notificationStyle = options.style || 1, this.displayTime = options.timeout || 5e3, 
        this.content = null;
    }
